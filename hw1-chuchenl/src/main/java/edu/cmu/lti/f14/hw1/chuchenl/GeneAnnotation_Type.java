...
public class GeneAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.f14.hw1.chuchenl.GeneAnnotation");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("content", "edu.cmu.lti.f14.hw1.chuchenl.GeneAnnotation");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "edu.cmu.lti.f14.hw1.chuchenl.GeneAnnotation");
